...
/**
 * Tipodebito generated by hbm2java
 */
@Entity
@Table(name = "tipodebito", schema = "public")
public class Tipodebito implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4078726891971555316L;
	...
	public Tipodebito(int idtipodebito, String nombre, int idestado,
	...
	public Tipodebito(int idtipodebito, String nombre, String abreviado,
			int idestado, int idusuario, Date fecha) {
		this.idtipodebito = idtipodebito;
		this.nombre = nombre;
	...
	@Id
	@Column(name = "idtipodebito", unique = true, nullable = false)
