/**
 * SecurityManagementSoapBindingStub.java
 *
...
public class SecurityManagementSoapBindingStub extends org.apache.axis.client.Stub implements net.cinecable.ws.sec.SecurityManagement {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.promptlink.com/xsd", "User"));
        oper.setReturnClass(net.cinecable.ws.User.class);
    ...
    public SecurityManagementSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SecurityManagementSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SecurityManagementSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = net.cinecable.ws.sec.WebServiceException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public net.cinecable.ws.User authenticate(java.lang.String login, java.lang.String password) throws java.rmi.RemoteException, net.cinecable.ws.sec.WebServiceException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.promptlink.com/xsd", "authenticate"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {login, password});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (net.cinecable.ws.User) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.cinecable.ws.User) org.apache.axis.utils.JavaUtils.convert(_resp, net.cinecable.ws.User.class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof net.cinecable.ws.sec.WebServiceException) {
              throw (net.cinecable.ws.sec.WebServiceException) axisFaultException.detail;
         }
   }
