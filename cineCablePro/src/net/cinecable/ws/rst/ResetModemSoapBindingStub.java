/**
 * ResetModemSoapBindingStub.java
 *
...
public class ResetModemSoapBindingStub extends org.apache.axis.client.Stub implements net.cinecable.ws.rst.ResetModem {
    ...
    public ResetModemSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ResetModemSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ResetModemSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = net.cinecable.ws.rst.WebServiceException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public void resetModem(java.lang.String mac, net.cinecable.ws.User initiator) throws java.rmi.RemoteException, net.cinecable.ws.rst.WebServiceException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.promptlink.com/xsd", "resetModem"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mac, initiator});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof net.cinecable.ws.rst.WebServiceException) {
              throw (net.cinecable.ws.rst.WebServiceException) axisFaultException.detail;
         }
   }
